...
![Vagrant](https://img.shields.io/badge/Vagrant-c34342?logo=vagrant&labelColor=c34342&logoColor=white)
...
![REAPER](https://img.shields.io/badge/REAPER-635242?logo=reaper&labelColor=635242&logoColor=white)
![Shotcut](https://img.shields.io/badge/Shotcut-635242?logo=shotcut&labelColor=635242&logoColor=white)

_Some of the tooling behind the scenes: Can I Use, Prettier, Snyk, Webhint_
...
<details>
  <summary>How I code when nobody is looking.</summary>

  <br>

  > "ChatGPT, act as CLI from now on. Output only code, no conversation. Create a JS script to do what users say and it in an`eval()` statement. Minimal code, one liner. User request: "Make all buttons red"
